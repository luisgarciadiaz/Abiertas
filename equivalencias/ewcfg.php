...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "16.0.3");
...
$CONFIG = [
	...
	"RANDOM_KEY" => '7kI38Sv189FBF35q', // Random key for encryption
	...
	"PROJECT_ID" => "{BCBBB89F-782F-4C8E-A4DB-F05CA52E74C8}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "tracking"]
	],
